...
/*
Class that write events into Pravega
 */
public class PravegaWriter implements AutoCloseable{
    ...
    public PravegaWriter(String scope, String streamName, EventStreamWriter<String> writer, TransactionalEventStreamWriter<String> writerTxn) {
        this.scope = scope;
    ...
    public static void main(String[] args) {
        ...
        try(EventStreamClientFactory clientFactory = EventStreamClientFactory.withScope(scope, ClientConfig.builder().controllerURI(controllerURI).build());
            ...
            PravegaWriter cw = new PravegaWriter(scope, streamName, writer, writerTxn)){
            cw.run();
        } catch (IOException e) {
            e.printStackTrace();
        }
